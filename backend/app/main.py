...
from domains.settings.routes_payment_terms import router as payment_terms_router
...
def create_app() -> FastAPI:
	...
	api_v1.include_router(manufacturing_router, prefix="/manufacturing", tags=["manufacturing"])
