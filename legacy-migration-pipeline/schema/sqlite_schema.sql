...
CREATE TABLE sales_orders (
    ...
    contact_phone TEXT,
    contact_person TEXT,
    warehouse_id TEXT DEFAULT 'A',
    currency_code TEXT DEFAULT 'NTD',
    ...
    shipping_status TEXT DEFAULT '0',
    order_status TEXT DEFAULT '1',
    slip_type TEXT DEFAULT '1',
    memo TEXT,
    created_by TEXT,
...
CREATE TABLE sales_order_lines (
    ...
    warehouse_id TEXT DEFAULT 'A',
    delivery_date TEXT,
    status TEXT DEFAULT 'A' CHECK (status IN ('A', 'I', 'C')),
    memo TEXT,
    created_at TEXT DEFAULT (datetime('now')),
    updated_at TEXT DEFAULT (datetime('now')),
...
CREATE TABLE purchase_orders (
    ...
    total_amount REAL DEFAULT 0,
    payment_status TEXT DEFAULT '0',
    receiving_status TEXT DEFAULT '0',
    order_status TEXT DEFAULT '1',
    slip_type TEXT DEFAULT '4',
    memo TEXT,
    created_by TEXT,
    created_at TEXT DEFAULT (datetime('now')),
    updated_at TEXT DEFAULT (datetime('now')),
...
CREATE TABLE chart_of_accounts (
    ...
    balance_type TEXT DEFAULT 'D' CHECK (balance_type IN ('D', 'C')),
    subclass_id TEXT,
    subclass_name TEXT,
    is_active INTEGER DEFAULT 1,
    is_control_account INTEGER DEFAULT 0,
    allow_direct_entry INTEGER DEFAULT 1,
    tax_type TEXT,
...
('1143', 'customer', '恆峰', '恆峰', NULL, '陳先生', '02-25918322', '台北市大同區迪化街二段191巷9號1樓', '103', 'A', '2024-08-26'),
('2308', 'customer', '吉科', '吉科', NULL, NULL, '0933553963', '台中市大里區爽文路859巷8號', '412', 'A', '2024-01-08'),
('2514', 'customer', '順順', '順順', NULL, NULL, '047513388', '彰化市崙平南路201號', '500', 'A', '2024-08-27'),
('2716', 'customer', '晉昌', '晉昌', NULL, NULL, '047551050', '彰化縣和美鎮湖內里彰新路6段657號', '508', 'A', '2024-08-27'),
('2801', 'customer', '明欣', '明欣', NULL, NULL, '048323014', '彰化縣員林市莒光路59號', '510', 'A', '2024-08-27'),
('T002', 'supplier', '燦達企業', '燦達', NULL, NULL, '0225581621', '台北市大同區太原路73號3F-5', '103', 'A', '2024-08-30'),
('T033', 'supplier', '建億橡膠股份有限公司', '建億', NULL, '陳先生', '048365466', '彰化縣員林市鎮興里麒麟巷212弄66號', '510', 'A', '2019-08-14'),
('T067', 'supplier', '勝梨', '勝梨', NULL, NULL, '03-4614001~3', '桃園市中壢區福星三街11號', '320', 'A', '2024-08-27'),
('T068', 'supplier', '達基', '達基', NULL, NULL, '02-27918100', '台北市內湖區民權東路六段21巷25號', '114', 'A', '2024-08-26');
...
('1', '0001', '應收帳款', 'Accounts Receivable', 'asset', 'D', '11', 1),
('2', '0002', '應收票據', 'Notes Receivable', 'asset', 'D', '11', 1),
('3', '1110', '零用金', 'Petty Cash', 'asset', 'D', '11', 1),
('4', '1111', '現金', 'Cash', 'asset', 'D', '11', 1),
('5', '1112', '銀行存款', 'Cash in Banks', 'asset', 'D', '11', 1),
('6', '1113', '銀行存款-台灣銀行', 'Bank of Taiwan', 'asset', 'D', '11', 1);

-- Banks
INSERT INTO banks (bank_id, bank_code, bank_name, branch_name, is_active) VALUES
('0040037', '004', '臺灣銀行', '營業部', 1),
('0040048', '004', '臺灣銀行', '發行部', 1),
('0040059', '004', '臺灣銀行', '公庫部', 1),
('0040071', '004', '臺灣銀行', '館前分行', 1),
('0040082', '004', '臺灣銀行', '信託部', 1);
