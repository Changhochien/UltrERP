...
def _line_to_dict(line: SupplierInvoiceLine, product_names: dict[uuid.UUID, str]) -> dict:
    ...
    return {
        ...
        "base_unit_price": getattr(line, "base_unit_price", None),
        "base_subtotal_amount": getattr(line, "base_subtotal_amount", None),
        "base_tax_amount": getattr(line, "base_tax_amount", None),
        "base_total_amount": getattr(line, "base_total_amount", None),
...
async def get_supplier_invoice(
    ...
    return {
        ...
        "conversion_rate": getattr(invoice, "conversion_rate", None),
        "conversion_effective_date": getattr(invoice, "conversion_effective_date", None),
        "applied_rate_source": getattr(invoice, "applied_rate_source", None),
        "currency_source": getattr(invoice, "currency_source", None),
        "payment_terms_source": getattr(invoice, "payment_terms_source", None),
        "base_subtotal_amount": getattr(invoice, "base_subtotal_amount", None),
        "base_tax_amount": getattr(invoice, "base_tax_amount", None),
        "base_total_amount": getattr(invoice, "base_total_amount", None),
        "remaining_base_payable_amount": getattr(invoice, "remaining_base_payable_amount", None),
