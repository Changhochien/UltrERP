...
4. Epic 38 stories can be split across teams (payment gateways vs. banking) if dependencies are met.

---

## Story 38.1: LINE Pay Integration
...
## Story 38.3: Taiwan Banking Reconciliation
...
## Story 38.4: Taiwan Logistics API (Optional)
