...
Computes period-over-period category demand trends from qualifying order lines,
including revenue deltas, customer counts, and new/churned customer tracking.
"""
...
from domains.intelligence.schemas import CategoryTrend, CategoryTrends, TopProductByRevenue
...
async def get_category_trends(
    ...
    *,
    ...
    Analyzes category-level metrics including:
    - Revenue comparison between current and prior periods
    - Order and customer count deltas
    - New and churned customer tracking
...
def _build_category_growth_signals(
    ...
    """Build category growth signals from trends for use by market opportunities."""
    growth_trends = [
        trend
        for trend in trends
