...
.ips-header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 2mm; }
...
.ips-customer { display: flex; justify-content: space-between; border: 0.5pt solid #333; padding: 1.5mm 2mm; margin-bottom: 2mm; font-size: 8pt; line-height: 1.8; }
...
.ips-footer { display: grid; grid-template-columns: 76mm 1fr; border: 0.5pt solid #333; font-size: 8pt; }
...
.ips-footer-notes { display: flex; justify-content: space-between; border-top: 0.5pt solid #333; padding: 1.5mm 2mm; min-height: 8mm; }
...
<div class="ips-customer">
  <div class="ips-customer-left">
    <div><span class="ips-field-label">統一編號：</span>{_esc(invoice.buyer_identifier_snapshot)}</div>
  </div>
</div>
...
<div class="ips-footer">
  ...
  <div class="ips-footer-right">
    <div class="ips-footer-row"><span class="ips-field-label">合　　計</span><span>{_format_amount(invoice.subtotal_amount)}</span></div>
    <div class="ips-footer-row"><span class="ips-field-label">營業稅</span><span>{_format_amount(invoice.tax_amount)}</span></div>
    <div class="ips-footer-row"><span class="ips-field-label">總　　計</span><span style="font-weight:700">{_format_amount(invoice.total_amount)}</span></div>
  </div>
</div>
