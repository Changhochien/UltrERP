		...
		<div className="invoice-print-sheet">
			...
			<div className="ips-doc-row">
				...
				<span className="ips-doc-number">
					<span className="ips-field-label">{t("print.documentNumber")}</span>
			...
			<div className="ips-customer">
				<div className="ips-customer-left">
					<div>
						<span className="ips-field-label">{t("print.customerName")}</span>
						{customer.company_name}
					</div>
					<div>
						<span className="ips-field-label">{t("print.taxId")}</span>
						{invoice.buyer_identifier_snapshot}
					</div>
					<div>
						<span className="ips-field-label">{t("print.invoiceAddress")}</span>
						{customer.billing_address}
					</div>
					{customer.shipping_address && (
						<div>
							<span className="ips-field-label">{t("print.shippingAddress")}</span>
							{customer.shipping_address}
						</div>
					)}
				</div>
				<div className="ips-customer-right">
					<div>
						<span className="ips-field-label">{t("print.contactPhone")}</span>
						{customer.contact_phone}
					</div>
					{customer.contact_fax && (
						<div>
							<span className="ips-field-label">{t("print.faxNumber")}</span>
							{customer.contact_fax}
						</div>
					)}
					<div>
						<span className="ips-field-label">{t("print.contactPerson")}</span>
			...
			<table className="ips-grid">
				<thead>
					<tr>
						<th className="ips-col-code">{t("print.col.productCode")}</th>
						<th className="ips-col-desc">{t("print.col.description")}</th>
						<th className="ips-col-qty">{t("print.col.quantity")}</th>
						<th className="ips-col-unit">{t("print.col.unit")}</th>
						<th className="ips-col-price">{t("print.col.unitPrice")}</th>
						<th className="ips-col-net">{t("print.col.netPrice")}</th>
						<th className="ips-col-amount">{t("print.col.amount")}</th>
					</tr>
				</thead>
				<tbody>
					{invoice.lines.map((line) => (
						<tr key={line.id}>
							...
							<td className="ips-col-unit">{t("print.unit")}</td>
			...
			<div className="ips-footer">
				<div className="ips-footer-left">
					<div className="ips-footer-row">
						<span className="ips-field-label">{t("print.discount")}</span>
						<span />
					</div>
					<div className="ips-footer-row">
						<span className="ips-field-label">{t("print.unpaid")}</span>
						<span />
					</div>
				</div>
				<div className="ips-footer-right">
					<div className="ips-footer-row">
						<span className="ips-field-label">{t("print.subtotal")}</span>
						<span>{formatAmount(invoice.subtotal_amount)}</span>
					</div>
					<div className="ips-footer-row">
						<span className="ips-field-label">{t("print.tax")}</span>
						<span>{formatAmount(invoice.tax_amount)}</span>
					</div>
					<div className="ips-footer-row">
						<span className="ips-field-label">{t("print.total")}</span>
			...
			<div className="ips-footer-notes">
				<div className="ips-footer-notes-left">
					<span className="ips-field-label">{t("print.notes")}</span>
				</div>
				<div className="ips-footer-notes-right">
					<span className="ips-field-label">{t("print.customerSignature")}</span>
				</div>
			</div>
