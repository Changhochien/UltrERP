---
name: legacy-import
description: Guide the reviewed UltrERP legacy-import workflow through the stable backend CLI. Use when asked to extract a raw SQL dump, plan, stage, normalize, export or import product review CSVs, map products, run canonical import, or validate a legacy import batch.
